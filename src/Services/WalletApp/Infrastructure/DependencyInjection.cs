...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddUserManagementOptions(configuration);
    ...
    /// </summary>
    public static IServiceCollection AddUserManagementOptions(this IServiceCollection services, IConfiguration configuration)
    {
        services.Configure<UserManagementOptions>(
            configuration.GetSection("UserManagement"));

        services.AddHttpClient<IUserManagementService, UserManagementServiceClient>((sp, client) =>
        {
            var options = sp.GetRequiredService<IOptions<UserManagementOptions>>().Value;
