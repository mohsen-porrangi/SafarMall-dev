...
namespace PaymentGateway.API.Features.VerifyPayment;
...
public class VerifyPaymentEndpoint : ICarterModule
{
        ...
        CancellationToken cancellationToken)
    {
        var command = new VerifyPaymentCommand
        {
            ...
            GatewayType = (Models.PaymentGatewayType)request.GatewayType
        };
           ...
           CancellationToken cancellationToken = default)
    {
        var command = new VerifyPaymentCommand
        {
            ...
            Status = Status,
            Amount = Amount,
            GatewayType = (Models.PaymentGatewayType)gateway
        };
