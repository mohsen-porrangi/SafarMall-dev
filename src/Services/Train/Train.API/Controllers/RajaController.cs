...
namespace Train.API.Controllers
{
        ...
        ) : ControllerBase
    {
        ...
        public async Task<IActionResult> ReserveTrainAsync([FromBody] TrainReserveRequest request)
        {

            var userId = new Guid("4F2F98EC-85D3-4AD9-9B14-D5ECD2C4F211");//userService.GetCurrentUserId();
        ...
        /// <returns></returns>
        [HttpGet("ToPay")]
        public async Task<IActionResult> ToPayAsync([FromQuery] int orderId)
        {
        ...
        public async Task<IActionResult> ConfirmReservedAsync([FromQuery] int orderNumber)
        {
